...
import { validateRuntime, validateArray, validateString } from "../lib/validator.js";
...
function extractFields(body: unknown): string[] {
  ...
  function traverse(value: unknown, prefix = ""): void {
...
export function createValidateResponseTool(): Tool {
  return {
...
export async function handleValidateResponse(
