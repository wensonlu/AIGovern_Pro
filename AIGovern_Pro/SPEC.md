# AIGovern_Pro - AI Debug MCP 技术规格文档
...
```
AIGovern_Pro/
├── agent-debug-mcp/              # AI Debug MCP（本期 P0）
│   ├── src/
...
const server = new Server(
  { name: "agent-debug-mcp", version: "0.1.0" },
  { capabilities: { tools: {} } }
);
