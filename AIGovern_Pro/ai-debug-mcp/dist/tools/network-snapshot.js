...
import { validateRuntime, validateTimeRange, filterByTimeRange, matchUrlPattern, } from "../lib/validator.js";
export function createNetworkSnapshotTool() {
    return {
...
export async function handleNetworkSnapshot(args) {
